...
class AddAuditTrailingSettingsMethod extends Component {
...
AddAuditTrailingSettingsMethod.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AddAuditTrailingSettingsMethod);
