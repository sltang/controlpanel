...
class EditAuditTrailingSettingsResults extends Component {
...
EditAuditTrailingSettingsResults.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(EditAuditTrailingSettingsResults);
