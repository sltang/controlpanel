...
class EditAuditTrailSettingsSequence extends Component {
...
EditAuditTrailSettingsSequence.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(EditAuditTrailSettingsSequence);
