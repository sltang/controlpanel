...
class EditAuditTrailingSettingsSequence extends Component {
...
EditAuditTrailingSettingsSequence.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(EditAuditTrailingSettingsSequence);
