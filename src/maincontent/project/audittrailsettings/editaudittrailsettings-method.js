...
class EditAuditTrailSettingsMethod extends Component {
...
EditAuditTrailSettingsMethod.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(EditAuditTrailSettingsMethod);
