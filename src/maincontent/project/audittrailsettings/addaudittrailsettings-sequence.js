...
class AddAuditTrailingSettingsSequence extends Component {
...
AddAuditTrailingSettingsSequence.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AddAuditTrailingSettingsSequence);
