...
class EditAuditTrailingSettingsAll extends Component {
...
EditAuditTrailingSettingsAll.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(EditAuditTrailingSettingsAll);
