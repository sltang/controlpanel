...
import EditAuditTrailingSettingsAll from './audittrailsettings/editaudittrailsettings-all';
import EditAuditTrailingSettingsMethod from './audittrailsettings/editaudittrailsettings-method';
import EditAuditTrailingSettingsSequence from './audittrailsettings/editaudittrailsettings-sequence';
import EditAuditTrailingSettingsResults from './audittrailsettings/editaudittrailsettings-results';
...
class EditAuditTrailingSettings extends Component {
        ...
        <div className={classes.root}>
         <div position="static">
          ...
          {value === 0 && <TabContainer>
            <EditAuditTrailingSettingsAll project={project} reasons={reasons.all} type="all"
            ...
            /></TabContainer>}
          {value === 1 && <TabContainer><EditAuditTrailingSettingsMethod project={project} reasons={reasons.method} type="method"
              onDelete={this.handleDelete}
              onMoveUp={this.handleMoveUp}
              onMoveDown={this.handleMoveDown}
              onSelect={this.handleSelect}
              ...
              prompt={prompt}
            /></TabContainer>}
          {value === 2 && <TabContainer><EditAuditTrailingSettingsSequence project={project} reasons={reasons.sequence} type="sequence"
              onDelete={this.handleDelete}
              onMoveUp={this.handleMoveUp}
              onMoveDown={this.handleMoveDown}
              onSelect={this.handleSelect}
              ...
              prompt={prompt}          
          /></TabContainer>}
          {value === 3 && <TabContainer><EditAuditTrailingSettingsResults project={project} reasons={reasons.results} type="results"
              onDelete={this.handleDelete}
              onMoveUp={this.handleMoveUp}
              onMoveDown={this.handleMoveDown}
              onSelect={this.handleSelect}
...
EditAuditTrailingSettings.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(EditAuditTrailingSettings);
